...
// exhausted.
func (c *Cursor) Next(result interface{}) bool { _ = "STUB: not implemented"; return false }
...
func (c *Cursor) All(results interface{}) error { _ = "STUB: not implemented"; return nil }
...
func (c *Cursor) Close() error { _ = "STUB: not implemented"; return nil }

// Err return the last error of Cursor, if no error occurs, return nil
func (c *Cursor) Err() error { _ = "STUB: not implemented"; return nil }
